...
main( int argc, char** argv )
{
    ...
    "prefix,p",
    boost::program_options::value< std::string >( &prefix )->default_value( "left_" ),
    "Prefix of images" )( "file-extension,e",
                          boost::program_options::value< std::string >( &fileExtension )->default_value( ".bmp" ),
                          "File extension of images" )(
    "camera-model,m",
    boost::program_options::value< std::string >( &cameraModel )->default_value( "kannala-brandt" ),
